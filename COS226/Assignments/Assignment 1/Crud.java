...
public class Crud {
    public volatile Queue<Info> database = new LinkedList<>(); 

    public volatile Queue<Info> create = new LinkedList<>();
    public volatile Queue<Boolean> read = new LinkedList<>();
    public volatile Queue<Info> update = new LinkedList<>();
    public volatile Queue<Info> delete = new LinkedList<>();
